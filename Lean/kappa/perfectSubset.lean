  ...
  have himg : (fun x : ℝ => -x) '' SRight = SLeftNeg := by
    ...
    · intro hz
      ...
      have hRight :
        ...
        -- Achtung: zuerst Bild-Lemma, dann `negPre_negPre`
